...
pyinit_replacements = {
    ...
    "PYINIT_CONFIG_PROJECT_ROOT": find_root() + '/stm32_files'
}

# FIXME change this to a tree walk of template_files
replacement_files = [('template_files/stm32_files/stm32_cross_properties.cfg', 'stm32_files/stm32_cross_properties.cfg')]
